...
// Specific test for the plus sign encoding issue
Deno.test({
  name: "object name with plus sign URL encoding",
  fn: async () => {
    const objectName = "apps/com.demo.app/3.0.125+b.1549437.master.f5d735b49.zip";
