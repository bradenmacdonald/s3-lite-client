...
Deno.test("presignedPostObject", async () => {
...
Deno.test("presignedPostObject - with policy condition violations", async () => {
  ...
  assert(
    errorXml.includes("EntityTooLarge") || errorXml.includes("MaxSizeExceeded") || errorXml.includes("ConditionFailed"),
  );
