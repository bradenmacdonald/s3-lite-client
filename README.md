...
- Deno (no install): `import { S3Client } from "jsr:@bradenmacdonald/s3-lite-client@0.9.2";`
...
- Browser:
  ```html
  <script type="module">
    import { S3Client } from "https://esm.sh/jsr/@bradenmacdonald/s3-lite-client@0.9.2";
    // Or:
    const { S3Client } = await import("https://esm.sh/jsr/@bradenmacdonald/s3-lite-client@0.9.2");
  </script>
  ```
